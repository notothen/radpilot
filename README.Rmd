...
16/12/2020: add a modified read.bioanalyzer function to read in xml file with a missing lower marker in one sample
...
11-12/2020: updated 02_empirical_digests.R & added a customized plotting function in recto_REs_and_functions.R
...
* analyses/recto_REs_and_functions.R
...
To be run sequentially, all listed under /analyses.
