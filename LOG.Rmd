...
* coverage_stats.csv: number of loci and coverage for each library under different M values as reported in gstacks.log.distribs files

* density_stats.csv: additional statistics for each library as reported in populations.log files
